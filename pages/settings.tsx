          ...
          <div className="bg-white rounded-lg shadow-sm p-8 border border-gray-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="flex gap-4 pt-8 border-t border-gray-200">
                <button
                  type="submit"
                  className="flex-1 bg-gray-900 text-white py-4 px-6 rounded font-semibold hover:bg-gray-800 transition-colors"
                >
                  설정 저장
                </button>
                <Link
                  href="/"
                  className="flex-1 bg-white border border-gray-300 text-gray-900 py-4 px-6 rounded font-semibold hover:bg-gray-50 transition-colors text-center"
                >
                  취소
                </Link>
              </div>
